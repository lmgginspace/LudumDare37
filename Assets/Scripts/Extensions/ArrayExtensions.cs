...
namespace Extensions.System
{
    public static class ArrayExtensions
    {
        ...
        /// array actual.
        /// </summary>
        private static string ItemListToString(this Array array, string separator)
        {
        ...
        /// array actual.
        /// </summary>
        private static string ItemListToString(this Array array, string separator, string start, string end)
        {
