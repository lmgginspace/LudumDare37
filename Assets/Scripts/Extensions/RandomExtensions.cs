...
namespace Extensions.UnityEngine
{
    public static class RandomUtil
    {
        ...
        /// intervalo de valores que contiene el 95% de los valores de la distribución (el equivalente a 2 veces la
        /// desviación típica a cada lado del valor medio).
        /// </summary>
        ...
        {
            return max > min ? RandomUtil.NextGaussian((min + max) * 0.5f, (0.5f * min) + (1.5f * max))
                             : RandomUtil.NextGaussian((min + max) * 0.5f, (1.5f * min) + (0.5f * max));
        }
